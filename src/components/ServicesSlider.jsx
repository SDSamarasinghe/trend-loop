                ...
                <div className="h-full flex items-center justify-center px-4">
                  <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-[#FF9933]/10 overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                      ...
                      {/* Right Side - Visual */}
                      <div className="relative bg-gradient-to-br from-[#FF9933]/5 via-[#FF9933]/10 to-[#FF9933]/5 p-8 md:p-12 flex items-center justify-center">
                        <div className="relative w-48 h-48">
                          {/* Decorative circles */}
                          <div className="absolute inset-0 rounded-full bg-[#FF9933]/10 animate-pulse"></div>
                          <div className="absolute inset-4 rounded-full bg-[#FF9933]/20"></div>
                          <div className="absolute inset-8 rounded-full bg-[#FF9933]/30"></div>
                          
                          {/* Center icon/number */}
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-6xl font-bold text-[#FF9933]">
                              {index + 1}
                            </div>
                          </div>
                        </div>
